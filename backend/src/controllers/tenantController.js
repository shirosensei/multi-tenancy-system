...
var createTenant = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, subdomain, existingTenant, tenant, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, name = _a.name, subdomain = _a.subdomain;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 4, , 5]);
                return [4 /*yield*/, prisma_1["default"].tenant.findUnique({
                        where: { id: subdomain }
                    })];
            case 2:
                ...
                return [4 /*yield*/, prisma_1["default"].tenant.create({
                        data: {
                            name: name,
                            domain: subdomain,
                            createdAt: new Date()
